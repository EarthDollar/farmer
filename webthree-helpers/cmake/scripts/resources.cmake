...
foreach(resource ${ETH_RESOURCES})
	...
	set(ETH_RESULT_DATA "${ETH_RESULT_DATA}	static const unsigned char ed_${resource}[] = {\n	// ${filename}\n	${filedata}\n};\n")

	# append init resources
	set(ETH_RESULT_INIT "${ETH_RESULT_INIT}	m_resources[\"${resource}\"] = (char const*)ed_${resource};\n")
	set(ETH_RESULT_INIT "${ETH_RESULT_INIT}	m_sizes[\"${resource}\"]     = sizeof(ed_${resource});\n")
